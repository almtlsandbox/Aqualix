...
if not exist "Aqualix-v1.0.0-Windows-.zip" (
...
echo ✅ Archive trouvée: Aqualix-v1.0.0-Windows-.zip
for %%A in ("Aqualix-v1.0.0-Windows-.zip") do echo    Taille: %%~zA bytes
...
echo 4. Utilisez le tag: v1.0.0-windows
echo 5. Ajoutez le titre: "Aqualix v1.0.0 - Version Exécutable Windows"
...
start "GitHub" "https://github.com/almtlsandbox/Aqualix/releases/new?tag=v1.0.0-windows&title=Aqualix%%20v1.0.0%%20-%%20Version%%20Exécutable%%20Windows"

echo.
echo 🌐 GitHub ouvert dans votre navigateur!
echo.
echo 📁 L'archive à attacher se trouve dans ce dossier:
echo    %CD%\Aqualix-v1.0.0-Windows-.zip
echo.
